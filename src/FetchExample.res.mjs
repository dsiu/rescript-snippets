...
function login(email, password) {
  ...
  return $$Promise.$$catch(globalThis.fetch("https://reqres.in/api/login", params).then(res => res.json()).then(data => {
    let msg = data.error;
    let tmp;
    if (msg == null) {
...
function getProducts(token, param) {
  ...
  return $$Promise.$$catch(globalThis.fetch("https://reqres.in/api/products", params).then(res => res.json()).then(data => {
...
$$Promise.$$catch(login("emma.wong@reqres.in", "pw").then(ret => {
  if (ret.TAG !== "Ok") {
