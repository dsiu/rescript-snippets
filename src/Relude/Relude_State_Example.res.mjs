...
let __x$5 = bind(push(1), param => bind(push(1), param => bind(push(2), param => bind(push(3), param => bind(pop, param => bind(pop, param => bind(pop, param => bind(push(4), param => flipMap(push(5), a => a * 100 | 0)))))))));
