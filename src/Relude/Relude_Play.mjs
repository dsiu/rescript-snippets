...
var prim = Relude_Array_Instances.bind(arr, plus1);

console.log(prim);

var arr_rev = Relude_Array_Instances.bind(arr, reverseTuple);
...
var prim$1 = sort$1(arr_rev);

console.log(prim$1);

var prim$2 = (function (__x) {
      return Relude_Array_Instances.showBy((function (extra) {
                    return Relude_Tuple.showBy2(Relude_String.show, Relude_Int.show, extra);
                  }), __x);
    })(arr_rev);
