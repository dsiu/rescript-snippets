...
function enqueue(in_list, out_list, x) {
  return [
          {
            hd: x,
            tl: in_list
...
function dequeue(in_list, out_list) {
  if (out_list) {
    return [
            out_list.hd,
            [
...
function fold(in_list, out_list, init, f) {
  var after_out = function (param) {
    var func = function (param$1) {
      return Belt_List.reduce(out_list, param, param$1);
    };
    return function (param) {
      return Curry._3(func, param, init, f);
    };
  };
  var partial_arg = Belt_List.reverse(in_list);
  var func = function (param, param$1) {
    return Belt_List.reduce(partial_arg, param, param$1);
  };
  var arg = Curry.__2(f);
  return function (param) {
    var func$1 = Curry._1(func, param);
    return function (param) {
      return Curry._3(func$1, param, after_out, arg);
    };
  };
}
...
function Extend(Arg) {
  ...
  var Short_circuit = /* @__PURE__ */Caml_exceptions.create("Ch10_Functors.Extending_Modules.Foldable.Extend(Arg).Short_circuit");
...
exports.Sharing_Constraints = Sharing_Constraints;
exports.Destructive_Substitution = Destructive_Substitution;
exports.Using_Multiple_Interfaces = Using_Multiple_Interfaces;
exports.Extending_Modules = Extending_Modules;
/*  Not a pure module */
