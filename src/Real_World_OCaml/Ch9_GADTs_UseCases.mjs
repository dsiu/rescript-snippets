    ...
    if (!l) {
      if (typeof if_not_found !== "object") {
        if (if_not_found === "Raise") {
          return PervasivesU.failwith("Element not found");
        } else {
          return ;
        }
      } else {
...
function flexible_find_2(f, _list, if_not_found) {
  while(true) {
    ...
    if (!list) {
      if (typeof if_not_found !== "object") {
        if (if_not_found === "Raise") {
          return PervasivesU.failwith("No matching item found");
        } else {
          return ;
        }
      } else {
...
((function (__x) {
        console.log("flexible_find_2", __x);
      })(flexible_find_2((function (x) {
              return x > 10;
            }), {
            hd: 1,
            tl: {
