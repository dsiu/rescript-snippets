...
var prim0$3 = FP_Utils.compose(g$p, (function (param) {
        return bind(f$p, param);
      }), 1.0);

console.log(prim0$3, "compose(g', bind(f'))(1.0) = ");

var prim0$4 = FP_Utils.compose(f$p, (function (param) {
...
function lift$p(param) {
  return FP_Utils.compose(f, unit, param);
}
...
function bindComplex(f, x) {
  return Belt_List.concatMany(Belt_List.toArray(Belt_List.map(x, f)));
}
...
var prim0$7 = Belt_List.toArray(bindComplex(sqrt$p, cbrt$p(2.0)));
