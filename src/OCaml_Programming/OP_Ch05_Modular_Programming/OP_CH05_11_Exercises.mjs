...
var empty = Belt_Map.make(CharCmp);

var nm = Belt_Map.set(Belt_Map.set(Belt_Map.set(Belt_Map.set(empty, /* 'A' */65, "Alpha"), /* 'E' */69, "Echo"), /* 'S' */83, "Sierra"), /* 'V' */86, "Victor");

var prim$1 = Belt_Map.toArray(nm);
...
var empty$1 = Belt_Map.make(DateCmp);

var dm = Belt_Map.set(empty$1, {
      month: 12,
      day: 1
    }, 1);

var prim$2 = Belt_Map.toArray(dm);
