...
var one_two_add = Curry._2(Stdlib__Function.compose, (function (param) {
        return Stdlib__Function.compose(one, two, param);
      }), add);

var one_two_sub = Curry._2(Stdlib__Function.compose, (function (param) {
        return Stdlib__Function.compose(one, two, param);
      }), sub);

show2(Curry._1(one_two_add, empty), "one_two_add");

show2(Curry._1(one_two_sub, empty), "one_two_sub");

function square$1(param) {
  return Stdlib__Function.compose(dup, mul, param);
}

show2(Curry._1(square$1, push(empty, 2.0)), "square");

var cube = Curry._2(Stdlib__Function.compose, Curry._2(Stdlib__Function.compose, (function (param) {
            return Stdlib__Function.compose(dup, dup, param);
          }), mul), mul);

show2(Curry._1(cube, push(empty, 3.0)), "cube");

function sum_numbers_upto(param) {
...
show2(sum_numbers_upto(Curry._1(square$1, push(empty, 3.0))), "sum up to 9");
