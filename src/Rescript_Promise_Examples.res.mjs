...
function causeErr() {
  return Promise.resolve(Exn.raiseError("Some JS error"));
}

$$Promise.$$catch(Promise.resolve().then(() => Promise.resolve(Exn.raiseError("Some JS error"))), e => {
  let tmp;
...
function causeJsErr() {
  return Exn.raiseError("Some JS error");
}
...
$$Promise.$$catch(Promise.resolve().then(() => {
...
$$Promise.$$catch(Promise.resolve(1).then(value => Promise.resolve(Promise.resolve(value + 2 | 0))).then(p => p.then(n => Promise.resolve((console.log(n), undefined)))), e => {
  console.log("luckily, our mistake will be caught here");
  console.log(e);
  return Promise.resolve();
});

$$Promise.$$catch(Promise.resolve(1).then(value => Promise.resolve(value)).then(p => {
  p.then(n => {
    console.log(n);
  });
}), e => {
